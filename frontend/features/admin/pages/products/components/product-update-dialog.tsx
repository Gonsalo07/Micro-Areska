...
} from '@admin/schemas/product/update-product.schema'
...
export function ProductUpdateDialog({ open, onClose, itemId }: Props) {
  const fetchFn = useCallback(() => adminProductsApi.getById(itemId), [itemId])
  ...
  >({
    ...
    onSubmit: async (values) => {
      await adminProductsApi.update(itemId, values)
    },
    onSuccess: () => {
      onClose()
      form.reset()
